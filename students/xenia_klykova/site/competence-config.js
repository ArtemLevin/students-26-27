window.STUDENT_COMPETENCE_CONFIG={
  ...
  evidence:{
    ...
    t5_bernoulli:{text:'28.08 введена и применена схема Бернулли P_n(k)=C_n^k p^k(1-p)^{n-k}; отработано определение n, k, p и выбор успеха по смыслу вопроса на кубике, монете, стрельбе и кофемашинах.',href:'28.08.26.html'},
