...
% Краткое сообщение Матвею: В задании №7 ошибка возникла при умножении степеней с одинаковым основанием. Показатели минус два и два нужно сложить; получается ноль, поэтому результат равен единице.
