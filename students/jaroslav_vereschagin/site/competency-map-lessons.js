...
(function () {
  ...
  const lessons = [
    ...
    {
      date: '14.09.26',
      title: 'Степени, квадратные корни, уравнения и системы',
      href: '14.09.26.html',
      note: 'Закрепление правил степеней и квадратных корней с модулем; решение линейных, полных и неполных квадратных уравнений; метод подстановки для систем; особый контроль знаков, скобок, сокращений и точных дробей. Базовый уровень подтверждённых навыков — 2 («пройдена с опорой»).',
      topicIds: [
        'oge_7_1_2',
        'oge_7_2_2',
        'oge_8_1_1',
