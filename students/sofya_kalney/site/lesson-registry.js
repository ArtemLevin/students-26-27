...
{date:'2026-08-26',href:'26.08.26.html',title:'Комплексное повторение алгебры ОГЭ',navTitle:'Повторение алгебры',navSubtitle:'уравнения, интервалы и модели',summary:'Группировка и факторизация, квадрат скобки, замена переменной, системы уравнений, метод интервалов, текстовые модели и графики рациональных функций после сокращения.',topics:['уравнения','системы','метод интервалов','текстовые задачи','ОДЗ и графики'],outcomes:[{label:'Распознавание метода уравнения',level:3,tone:'good'},{label:'Системы: ветви и подстановка',level:2,tone:'process'},{label:'ОДЗ и метод интервалов',level:3,tone:'good'}],materials:{pdf:'../pdf_docs/26.08.26.pdf',tex:'../tex_docs/26.08.26.tex'}},
