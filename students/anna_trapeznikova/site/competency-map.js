// Интерактивная логика персонального учебного навигатора.
(function () {
  'use strict';

  const DATA = window.ANNA_GRADE10_PROGRAM;
  if (!DATA || !Array.isArray(DATA.groups)) {
    throw new Error('Каталог программы Анны не найден');
  }
  ...
  function renderMap() {
    ...
    title.textContent = 'Круговая тепловая карта программы Анны Трапезниковой';
