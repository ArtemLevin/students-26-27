...
await runDashboardTests({student:'kirill_zinoviev',expectedLessons:12,stateKey:'kirill-competence-state-v2',storageKey:'kirill-competence-map-v2',catalog:{kind:'window-script',path:'students/kirill_zinoviev/site/competency-map-data.js',global:'KIRILL_GRADE7_GROUPS'}});
