...
export const radicalsGenerator={key:'algebra.radicals',version:1,title:'Квадратные корни',competencyIds:['t7_radical_num','t7_nth_root','t6_irrational','calc_10','calc_11'],generate(args){return context(this,args,(random,difficulty)=>{
